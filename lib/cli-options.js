module.exports = [
  ...
  { name: 'update', type: Boolean, alias: 'u', group: 'general' },
  ...
  { name: 'markers', type: String, alias: 'm', group: 'destination' },
  { name: 'large-file', type: Boolean, group: 'destination' },
  ...
  { name: 'use-hwd', type: Boolean, alias: 'U', group: 'destination' },
  ...
  { name: 'all-subtitles', type: String, group: 'subtitle' },
  { name: 'no-usage-stats', type: Boolean, group: 'general' }
]
